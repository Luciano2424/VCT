...
if st.session_state.page == "home":
    ...
    st.subheader("¡Explora las Estadísticas Más Impactantes del Torneo!")
    st.text("Sumérgete en el análisis completo del VCT Masters 2022 con gráficos que te mostrarán las métricas más emocionantes del torneo. Desde el rendimiento global de los equipos hasta los jugadores más letales en el campo de batalla, ¡aquí encontrarás todo lo que necesitas saber! ¿Quién dominó en Kills/Deaths? ¿Qué jugador logró más eliminaciones? ¿Quién lideró en muertes? ¡Haz clic para descubrir y revivir los momentos más épicos del torneo!")
...
if st.button("Ver todos los gráficos"):
        st.session_state.page = "graficos"
        
# Página de los gráficos
